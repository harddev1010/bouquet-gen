...
> = {
  january: {
    ...
    center_left: {
      ...
      transformCenter: { x: 0.891, y: 0.776 },
      baseRotation: -3.0,
      flowerPoly: [
        { x: 0.936, y: 0.44 },
        { x: 0.885, y: 0.322 },
    ...
    center_right: {
      ...
      transformCenter: { x: 0.116, y: 0.798 },
      baseRotation: 2.5,
      flowerPoly: [
        { x: 0.048, y: 0.548 },
        { x: 0.071, y: 0.402 },
  ...
  february: {
    ...
    center: { base: 'center_right', baseRotation: -20.0 },
    center_right: {
      base: 'center_right',
  ...
  march: {
    ...
    center: { base: 'center_right', baseRotation: -4.0 },
    center_right: {
      base: 'center_right',
  ...
  june: {
    left: {
      path: 'june_left.svg',
      transformCenter: { x: 0.274, y: 0.756 },
      baseRotation: -22.0,
      flowerPoly: [
        { x: 0.489, y: 0.54 },
        { x: 0.635, y: 0.358 },
    ...
    center_left: {
      path: 'june_left.svg',
      transformCenter: { x: 0.261, y: 0.768 },
      baseRotation: -22.0,
      flowerPoly: [
        { x: 0.489, y: 0.54 },
        { x: 0.635, y: 0.358 },
    ...
    center: { base: 'center_left', baseRotation: -21.0 },
    center_right: {
      base: 'center_right',
      path: 'june_right.svg',
      transformCenter: { x: 0.727, y: 0.76 },
      baseRotation: 22.0,
      flowerPoly: [
        { x: 0.572, y: 0.57 },
        { x: 0.446, y: 0.382 },
    ...
    right: {
      path: 'june_right.svg',
      transformCenter: { x: 0.718, y: 0.754 },
      baseRotation: 22.0,
      flowerPoly: [
        { x: 0.537, y: 0.586 },
        { x: 0.369, y: 0.356 },
  ...
  september: {
    left: {
      ...
      transformCenter: { x: 0.633, y: 0.686 },
      baseRotation: -6.0,
      flowerPoly: [
        { x: 0.72, y: 0.57 },
        { x: 0.783, y: 0.438 },
    ...
    center: { base: 'center_left', baseRotation: -6.0 },
    center_right: {
      base: 'center_right',
    ...
    right: {
      ...
      transformCenter: { x: 0.39, y: 0.734 },
      baseRotation: 7.0,
      flowerPoly: [
        { x: 0.379, y: 0.61 },
        { x: 0.402, y: 0.53 },
  ...
  december: {
    ...
    center_left: {
      ...
      transformCenter: { x: 0.925, y: 0.766 },
      baseRotation: 4.5,
      flowerPoly: [
        { x: 0.953, y: 0.554 },
        { x: 0.856, y: 0.398 },
    ...
    center_right: {
      ...
      transformCenter: { x: 0.071, y: 0.786 },
      baseRotation: -4.5,
      flowerPoly: [
        { x: 0.088, y: 0.58 },
        { x: 0.156, y: 0.482 },
